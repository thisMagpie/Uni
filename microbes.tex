...
$W$ is the work done by the system, $Q = Ne$ is the number of electrons transferred to the anode, multiplied by the charge of an electron. \Cref{eq:gfree} and \cref{eq:diff_electrodes} can be combined to give the emf in terms of the Gibbs free energy of the system under standard conditions as \cref{eq:emf_gibbs} describes.
